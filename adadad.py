    ...
    if selected_symptoms:
        ...
        try:
            ...
            if function_scores:
                ...
                elif best_match_function == 'handle_disease':
                    response = handle_disease(best_match_function,function_scores[best_match_function]['key'])
                elif best_match_function == 'handle_keyword':
